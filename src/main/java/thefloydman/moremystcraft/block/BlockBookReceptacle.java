...
public class BlockBookReceptacle extends BlockContainer {
	...
	public IBlockState getStateFromMeta(final int meta) {
		return this.getDefaultState().withProperty((IProperty) BlockBookReceptacle.ROTATION,
				(Comparable) EnumFacing.values()[meta]);
	}

	public int getMetaFromState(final IBlockState state) {
		return ((EnumFacing) state.getValue((IProperty) BlockBookReceptacle.ROTATION)).ordinal();
	}

	protected BlockStateContainer createBlockState() {
		return new BlockStateContainer((Block) this, new IProperty[] { BlockBookReceptacle.ROTATION });
	}
	...
	public AxisAlignedBB getBoundingBox(final IBlockState state, final IBlockAccess source, final BlockPos pos) {
		switch ((EnumFacing) state.getValue((IProperty) BlockBookReceptacle.ROTATION)) {
		case UP: {
		...
		default: {
			return BlockBookReceptacle.FULL_BLOCK_AABB;
		}
		}
	}
	...
	public void neighborChanged(final IBlockState state, final World worldIn, final BlockPos pos, final Block blockIn,
		...
		final BlockPos receptable = MoreMystcraftPortalUtils.getReceptacleBase(pos,
				(EnumFacing) state.getValue((IProperty) BlockBookReceptacle.ROTATION));
