...
public class MoreMystcraftSymbolRules {
    public static void initialize() {
        ...
        addRuleInternal("sun_color", buildRule(2, MoreMystcraftGrammarData.SUN_COLOR, MoreMystcraftGrammarRules.SUN_COLOR_EXT, GrammarData.GRADIENT_SEQ, Reference.forMoreMystcraft("sun_color")));
